...
$esewa_success_url = "http://" . $_SERVER['HTTP_HOST'] . "/hotel-bus-booking/esewa-success.php";
$esewa_failure_url = "http://" . $_SERVER['HTTP_HOST'] . "/hotel-bus-booking/esewa-failure.php";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($payment_method === 'manual') {
        ...
        $_SESSION['pending_booking'] = [
            ...
            'timestamp' => time() // Add timestamp for expiry check
        ];
        
        // The form will submit to eSewa
        // We don't need to do anything here as the form action points to eSewa
        // The actual booking will be created in esewa-success.php
    }
...
<body>
                    ...
                    <div class="payment-methods">
                        ...
                        <div class="payment-method <?= ($payment_method === 'manual') ? 'active' : '' ?>" id="manual-payment">
                            ...
                            <label for="method-manual" class="payment-method-label">
                                <div class="payment-icon">
                                    <img src="/hotel/assets/images/bank-transfer.png" alt="Bank Transfer">
                                </div>
                            ...
                            <div class="payment-content">
                                ...
                                <div class="qr-code">
                                    <img src="/hotel/uploads/payment_proofs/qr.png" alt="Payment QR Code">
                        ...
                        <div class="payment-method <?= ($payment_method === 'esewa') ? 'active' : '' ?>" id="esewa-payment">
                            ...
                            <label for="method-esewa" class="payment-method-label">
                                <div class="payment-icon">
                                    <img src="/hotel/assets/images/esewa-logo.png" alt="eSewa">
                                </div>
                                <div class="payment-details">
                            ...
                            <div class="payment-content">
                                ...
                                <form action="https://rc-epay.esewa.com.np/api/epay/main/v2/form" method="POST" id="esewa-payment-form">
                                    ...
                                    <input type="hidden" id="success_url" name="success_url" value="<?= $esewa_success_url ?>">
                                    ...
                                    <button type="submit" class="esewa-btn w-100" id="esewa-submit-btn">
                                        <img src="/hotel/assets/images/esewa-icon.png" alt="eSewa Icon"> 
                                        Pay with eSewa
                                    </button>
                                </form>
                            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Show loading overlay when eSewa form is submitted
            if (esewaForm) {
            ...
            const esewaBtn = document.getElementById('esewa-submit-btn');
            if (esewaBtn) {
